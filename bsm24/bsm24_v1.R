...
install.packages(c("rbacon", "dplyr", "tidyverse"))
libraries <- c("rbacon", "dplyr", "tidyverse")
...
df <- read.table(
  "/home/graciela/nextcloud/saco.csic.es/1 graciela/projects/Plan nacional/CORREDORAS/data/chronology_2025/BSM24/bsm24_v1.csv",
  header = TRUE,
  sep = ","
) %>%
  dplyr::mutate(
...
setwd("/home/graciela/nextcloud/saco.csic.es/1 graciela/projects/Plan nacional/CORREDORAS/data/chronology_2025/BSM24/bsm24_v1.csv")
write.table(df, file = "bsm24_v1_cal.csv", row.names = FALSE, col.names = TRUE, sep=",")
